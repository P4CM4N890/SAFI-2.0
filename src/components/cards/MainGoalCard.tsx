...
export const MainGoalCard = ({ title, startDate, endDate, progress }: Props) => {
    return (
        <View className='w-full items-center mt-6 rounded-xl border-2 border-slate-200 overflow-hidden bg-white'>
            ...
            <Text className='text-xl text-center font-bold text-primary uppercase my-2'>{ title }</Text>
            ...
            <Text className='text-sm text-black font-normal uppercase mt-2'>$1,000 / $2,000</Text>
            <Bar 
                progress={ progress } 
                height={ 10 } 
                color='#60D833' 
