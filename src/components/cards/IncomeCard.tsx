...
export const IncomeCard = ({ title, iconName, iconColor, money, time }: Props) => {
    return (
        <View className='w-full flex-row bg-white rounded-2xl p-2 border-2 border-slate-200 mt-2'>
            <View className='w-4/6 flex-row items-center gap-3'>
            ...
            <View className='w-2/6 justify-around'>
