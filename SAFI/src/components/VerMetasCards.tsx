...
export const VerMetasCards = (props: CardProps) => {
    const diferenciaEnTiempo = new Date(props.finish).getTime() - new Date(props.start).getTime();
    const diferenciaEnMeses = Math.floor((diferenciaEnTiempo / (1000 * 3600 * 24)) / 30);
    ...
    return (
        <View style={styles.containerMeta}>
                ...
                <View style={styles.containerFecha}>
                    ...
                    </View>
                    {
                        diferenciaEnMeses > 1 && 
                            <View style={styles.fecha}>
                                <View style={styles.boxFecha}>
                                    <Text style={styles.texto}>Ahorro mensual recomendado:  </Text>
                                </View>
                                <View style={styles.boxFecha}>
                                    <Text style={styles.textoFecha}>{ (props.total / diferenciaEnMeses).toFixed(2) }</Text>
                                </View>
                            </View>
                    }
                </View>
            ...
            <View style={styles.bttns}>
                ...
                <View style={{flex: 1}}>
                    <TouchableOpacity 
                        style={[styles.containerBtton, styles.bttn1]}
                ...
                <View style={{flex: 1}}>
                    <TouchableOpacity 
                        style={[styles.containerBtton, styles.bttn2]}
